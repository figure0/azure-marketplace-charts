...
```bash
helm upgrade my-release bitnami-azure/spring-cloud-dataflow --set mariadb.rootUser.password=[MARIADB_ROOT_PASSWORD]
```

#### v1.x.x

```bash
helm upgrade my-release bitnami-azure/spring-cloud-dataflow --set mariadb.auth.rootPassword=[MARIADB_ROOT_PASSWORD]
```
