...
| `server.image.tag`                           | Spring Cloud Dataflow image tag (immutable tags are recommended)                                                                 | `2.9.0-debian-10-r14`                                |
...
| `server.composedTaskRunner.image.tag`        | Spring Cloud Dataflow Composed Task Runner image tag (immutable tags are recommended)                                            | `2.9.0-debian-10-r15`                                |
...
| `skipper.image.tag`                          | Spring Cloud Skipper image tag (immutable tags are recommended)                                           | `2.8.0-debian-10-r14`          |
...
| `metrics.image.tag`                    | Prometheus Rsocket Proxy image tag (immutable tags are recommended)                                                        | `1.3.0-debian-10-r305`             |
...
| `waitForBackends.image.tag`          | Init container wait-for-backend image tag                                                         | `1.19.15-debian-10-r38` |
