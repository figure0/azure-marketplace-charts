...
| `server.image.tag`                           | Spring Cloud Dataflow image tag (immutable tags are recommended)                                                                 | `2.9.1-debian-10-r0`                                 |
...
| `server.composedTaskRunner.image.tag`        | Spring Cloud Dataflow Composed Task Runner image tag (immutable tags are recommended)                                            | `2.9.0-debian-10-r17`                                |
...
| `server.configuration.defaultSpringApplicationJSON`      | Injects default value for environment variable SPRING_APPLICATION_JSON                                               | `true`                                               |
...
| `skipper.image.tag`                          | Spring Cloud Skipper image tag (immutable tags are recommended)                                           | `2.8.0-debian-10-r15`          |
...
| `metrics.image.tag`                    | Prometheus Rsocket Proxy image tag (immutable tags are recommended)                                                        | `1.3.0-debian-10-r306`             |
...
| `waitForBackends.image.tag`          | Init container wait-for-backend image tag                                                         | `1.19.16-debian-10-r0` |
