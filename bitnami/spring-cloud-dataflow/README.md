...
| `server.image.tag`                           | Spring Cloud Dataflow image tag (immutable tags are recommended)                                                 | `2.8.1-debian-10-r33`                                |
...
| `server.composedTaskRunner.image.tag`        | Spring Cloud Dataflow Composed Task Runner image tag (immutable tags are recommended)                            | `2.8.1-debian-10-r34`                                |
...
| `skipper.image.tag`                          | Spring Cloud Skipper image tag (immutable tags are recommended)                                           | `2.7.1-debian-10-r34`          |
...
| `metrics.image.tag`                    | Prometheus Rsocket Proxy image tag (immutable tags are recommended)                                                        | `1.3.0-debian-10-r220`             |
...
| `waitForBackends.image.tag`          | Init container wait-for-backend image tag                                                         | `1.19.13-debian-10-r15` |
