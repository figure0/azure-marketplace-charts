...
$ helm install bitnami-azure/kibana --set elasticsearch.enabled=true
```
...
```console
$ helm install bitnami-azure/kibana --set configurationCM=myconfig
```
...
```console
$ helm install --name my-release -f ./values-production.yaml --set elasticsearch.enabled=false --set elasticsearch.external.hosts[0]=elasticsearch-host --set elasticsearch.external.port=9200 bitnami-azure/kibana
```
