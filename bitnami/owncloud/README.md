...
| `image.tag`                          | ownCloud Image tag (immutable tags are recommended)                                                          | `10.8.0-debian-10-r0` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)         | `10-debian-10-r140`                      |
