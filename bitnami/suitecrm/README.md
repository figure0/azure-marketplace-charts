...
| `image.tag`                             | SuiteCRM image tag (immutable tags are recommended)                                       | `7.12.6-debian-11-r12` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)              | `11-debian-11-r12`                       |
