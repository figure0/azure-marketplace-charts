...
| `image.tag`                          | SuiteCRM image tag (immutable tags are recommended)                                       | `7.11.21-debian-10-r0` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag                                                                                                               | `10-debian-10-r178`     |
...
| `metrics.image.tag`         | Apache exporter image tag (immutable tags are recommended) | `0.10.0-debian-10-r32`    |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)              | `10-debian-10-r178`                      |
