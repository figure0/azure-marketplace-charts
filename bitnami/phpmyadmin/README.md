...
| `image.tag`          | phpMyAdmin image tag (immutable tags are recommended)                | `5.1.1-debian-10-r47` |
...
| `metrics.image.tag`                        | Apache exporter image tag (immutable tags are recommended)                        | `0.10.0-debian-10-r4`     |
