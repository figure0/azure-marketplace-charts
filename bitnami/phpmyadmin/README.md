...
| `image.tag`          | phpMyAdmin image tag (immutable tags are recommended)                             | `5.2.0-debian-11-r9` |
...
| `metrics.image.tag`                        | Apache exporter image tag (immutable tags are recommended)                        | `0.11.0-debian-11-r10`    |
