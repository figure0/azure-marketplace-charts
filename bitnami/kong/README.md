...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.0.1-debian-11-r13` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.7.0-debian-11-r20`             |
...
| `postgresql.image.tag`                          | PostgreSQL image tag (immutable tags are recommended)                                                      | `14.6.0-debian-11-r6` |
