...
| `image.tag`         | kong image tag (immutable tags are recommended)                                                      | `3.1.1-debian-11-r12` |
...
| `ingressController.image.tag`                                   | Kong Ingress Controller image tag                                                                                                             | `2.8.0-debian-11-r5`              |
