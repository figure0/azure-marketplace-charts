...
| `server.image.tag`                      | TensorFlow Serving Image tag (immutable tags are recommended)                                                      | `2.10.1-debian-11-r0`        |
...
| `client.image.tag`                      | TensorFlow ResNet image tag (immutable tags are recommended)                                                       | `2.11.0-debian-11-r0`        |
