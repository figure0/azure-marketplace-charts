...
| `server.image.tag`                   | TensorFlow Serving Image tag (immutable tags are recommended)                             | `2.5.1-debian-10-r53`        |
...
| `client.image.tag`                   | TensorFlow ResNet Image tag (immutable tags are recommended)                              | `2.5.1-debian-10-r33`        |
