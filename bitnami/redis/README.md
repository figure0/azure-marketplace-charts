...
| `image.tag`         | Redis&reg; image tag (immutable tags are recommended)                                                      | `7.0.7-debian-11-r0` |
...
| `sentinel.image.tag`                          | Redis&reg; Sentinel image tag (immutable tags are recommended)                                                                              | `7.0.6-debian-11-r1`     |
...
| `metrics.image.tag`                          | Redis&reg; Exporter image tag (immutable tags are recommended)                                                      | `1.45.0-debian-11-r16`   |
...
| `sysctl.image.tag`                                     | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r62`      |
