...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.22.0-debian-11-r2` |
...
| `envoy.image.tag`                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.23.0-debian-11-r6` |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                            | `1.23.1-debian-11-r6`   |
