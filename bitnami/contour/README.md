...
| `contour.image.tag`                          | Contour image tag                                                                                                                  | `1.18.1-debian-10-r20` |
...
| `envoy.image.tag`                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.19.1-debian-10-r26` |
...
| `defaultBackend.image.tag`                          | Default backend image tag                                                                            | `1.21.3-debian-10-r12` |
