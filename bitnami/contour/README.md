...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.23.0-debian-11-r10` |
...
| `envoy.image.tag`                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.24.0-debian-11-r11` |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                                       | `1.23.2-debian-11-r14`   |
