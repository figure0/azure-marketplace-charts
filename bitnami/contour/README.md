...
| `contour.image.tag`                                           | Contour image tag                                                                                                                  | `1.23.1-debian-11-r0` |
...
| `envoy.image.tag`                                   | Envoy Proxy image tag (immutable tags are recommended)                                                                | `1.24.1-debian-11-r0` |
...
| `defaultBackend.image.tag`                             | Default backend image tag                                                                                       | `1.23.2-debian-11-r16`   |
