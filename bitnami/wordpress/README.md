...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `5.8.1-debian-10-r59` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r246`     |
