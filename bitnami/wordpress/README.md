...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `5.8.1-debian-10-r41` |
...
| `metrics.image.tag`                       | Apache Exporter image tag (immutable tags are recommended)                   | `0.10.1-debian-10-r27`    |
