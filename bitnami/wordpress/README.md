...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `5.8.0-debian-10-r18` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r173`     |
