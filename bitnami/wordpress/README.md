...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `6.0.1-debian-11-r1` |
...
| `volumePermissions.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                        | `11-debian-11-r15`      |
