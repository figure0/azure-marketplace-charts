...
| `image.tag`         | WordPress image tag (immutable tags are recommended) | `6.0.0-debian-11-r2` |
...
| `volumePermissions.image.tag`                          | Bitnami Shell image tag (immutable tags are recommended)                                        | `11-debian-11-r5`       |
...
| `metrics.image.tag`                          | Apache exporter image tag (immutable tags are recommended)                            | `0.11.0-debian-11-r6`     |
