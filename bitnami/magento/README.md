...
| `image.tag`                          | Magento image tag (immutable tags are recommended)                                                                   | `2.4.2-debian-10-r148` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                       | `10.3.31-debian-10-r16` |
...
| `volumePermissions.image.tag`          | Init container volume-permissions image tag (immutable tags are recommended)                                                                              | `10-debian-10-r170`     |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)         | `10-debian-10-r170`                      |
