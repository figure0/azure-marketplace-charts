...
| `image.tag`                          | Magento image tag (immutable tags are recommended)                                                                   | `2.4.3-debian-10-r52` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                       | `10.3.31-debian-10-r73` |
...
| `metrics.image.tag`           | Apache exporter image tag (immutable tags are recommended) | `0.10.1-debian-10-r29`    |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)         | `10-debian-10-r227`                      |
