...
| `image.tag`                             | Magento image tag (immutable tags are recommended)                                                                   | `2.4.5-p1-debian-11-r1` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                                      | `10.4.26-debian-11-r21` |
...
| `elasticsearch.image.tag`                 | Elasticsearch image tag (immutable tags are recommended)                                                      | `7.17.6-debian-11-r19`  |
