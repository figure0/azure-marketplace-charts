...
| `image.tag`                             | Magento image tag (immutable tags are recommended)                                                                   | `2.4.4-debian-11-r23` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                       | `10.4.25-debian-11-r23` |
...
| `elasticsearch.image.tag`                 | Elasticsearch image tag (immutable tags are recommended)                   | `7.17.5-debian-11-r12`  |
