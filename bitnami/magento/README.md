...
| `image.tag`                          | Magento image tag (immutable tags are recommended)                                                                   | `2.4.2-debian-10-r117` |
...
| `mariadb.image.tag`                         | MariaDB image tag (immutable tags are recommended)                                       | `10.3.30-debian-10-r14` |
