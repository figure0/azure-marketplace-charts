...
| `image.tag`                          | OpenCart image tag (immutable tags are recommended)                                       | `3.0.3-6-debian-10-r299` |
...
| `certificates.image.tag`                             | Container sidecar image tag (immutable tags are recommended)         | `10-debian-10-r138`                      |
