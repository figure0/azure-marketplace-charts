...
| `image.tag`                                   | Logstash image tag (immutable tags are recommended)                                                                  | `7.14.0-debian-10-r21`      |
...
| `metrics.image.tag`                           | Logstash Relay image tag (immutable tags are recommended)                                                            | `7.3.0-debian-10-r277`      |
