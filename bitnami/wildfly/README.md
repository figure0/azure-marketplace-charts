...
| `image.tag`         | WildFly image tag (immutable tags are recommended)                                                      | `26.1.2-debian-11-r20` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r46`      |
