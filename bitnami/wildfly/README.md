...
| `image.tag`         | WildFly image tag (immutable tags are recommended)                                                      | `27.0.0-debian-11-r4` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r55`      |
