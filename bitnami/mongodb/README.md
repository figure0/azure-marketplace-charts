...
| `image.tag`              | MongoDB(&reg;) image tag (immutable tags are recommended)                                                                                                    | `5.0.9-debian-10-r0`    |
...
| `tls.image.tag`          | Init container TLS certs setup image tag (immutable tags are recommended)                                                                                    | `1.21.6-debian-10-r118` |
...
| `externalAccess.autoDiscovery.image.tag`                 | Init container auto-discovery image tag (immutable tags are recommended)                                                                        | `1.24.0-debian-10-r6` |
...
| `metrics.image.tag`                          | MongoDB(&reg;) Prometheus exporter image tag (immutable tags are recommended)                                         | `0.32.0-debian-10-r28`     |
