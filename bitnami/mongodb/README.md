...
| `image.tag`              | MongoDB&reg; image tag (immutable tags are recommended)                                                                       | `4.4.9-debian-10-r21`  |
...
| `tls.image.tag`          | Init container TLS certs setup image tag (immutable tags are recommended)                                                     | `1.21.3-debian-10-r33` |
...
| `externalAccess.autoDiscovery.image.tag`                 | Init container auto-discovery image tag (immutable tags are recommended)                                                                      | `1.19.15-debian-10-r24` |
...
| `metrics.image.tag`                          | MongoDB&reg; Prometheus exporter image tag (immutable tags are recommended)                                           | `0.11.2-debian-10-r307`    |
