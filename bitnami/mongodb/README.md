...
| `image.tag`              | MongoDB&reg; image tag (immutable tags are recommended)                                                                       | `4.4.8-debian-10-r9`   |
...
| `tls.image.tag`          | Init container TLS certs setup image tag (immutable tags are recommended)                                                     | `1.21.1-debian-10-r31` |
...
| `externalAccess.autoDiscovery.image.tag`                 | Init container auto-discovery image tag (immutable tags are recommended)                                                                      | `1.19.13-debian-10-r24` |
...
| `metrics.image.tag`                          | MongoDB&reg; Prometheus exporter image tag (immutable tags are recommended)                                           | `0.11.2-debian-10-r245`    |
