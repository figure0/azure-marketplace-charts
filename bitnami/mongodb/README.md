...
| `image.tag`              | MongoDB(&reg;) image tag (immutable tags are recommended)                                                                                                    | `6.0.1-debian-11-r0`   |
...
| `tls.image.tag`          | Init container TLS certs setup image tag (immutable tags are recommended)                                                                                    | `1.23.1-debian-11-r10` |
...
| `externalAccess.autoDiscovery.image.tag`                 | Init container auto-discovery image tag (immutable tags are recommended)                                                                        | `1.24.3-debian-11-r12` |
...
| `metrics.image.tag`                          | MongoDB(&reg;) Prometheus exporter image tag (immutable tags are recommended)                                         | `0.34.0-debian-11-r4`      |
