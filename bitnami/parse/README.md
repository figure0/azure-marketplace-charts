...
| `server.image.tag`                          | Parse image tag (immutable tags are recommended)                                                       | `4.10.2-debian-10-r0` |
...
| `dashboard.image.tag`                          | Dashboard image tag (immutable tags are recommended)                                                      | `2.1.0-debian-10-r447`    |
