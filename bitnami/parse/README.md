...
| `server.image.tag`                                       | Parse image tag (immutable tags are recommended)                                                                         | `5.2.4-debian-11-r14` |
...
| `dashboard.image.tag`                                       | Dashboard image tag (immutable tags are recommended)                                                                     | `3.3.0-debian-11-r24`     |
