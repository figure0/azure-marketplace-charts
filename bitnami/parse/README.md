...
| `server.image.tag`                                       | Parse image tag (immutable tags are recommended)                                                                         | `5.3.3-debian-11-r0` |
...
| `dashboard.image.tag`                                       | Dashboard image tag (immutable tags are recommended)                                                                     | `3.3.0-debian-11-r56`     |
