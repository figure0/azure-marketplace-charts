...
| `image.tag`                   | Cassandra image tag (immutable tags are recommended)                                                                   | `4.0.0-debian-10-r17` |
...
| `volumePermissions.image.tag`                 | Init container volume                                                           | `10-debian-10-r172`     |
...
| `metrics.image.tag`                    | Cassandra exporter image tag                                                                           | `2.3.4-debian-10-r497`       |
