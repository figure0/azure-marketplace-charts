...
```console
$ helm repo add bitnami-azure https://marketplace.azurecr.io
$ helm install bitnami-azure/fluentd
```
...
$ helm install --name my-release \
  --set aggregator.port=24444 bitnami-azure/fluentd
```
...
```console
$ helm install --name my-release -f values.yaml bitnami-azure/fluentd
```
...
```console
$ helm install --name my-release -f ./values-production.yaml bitnami-azure/fluentd
```
...
```console
$ helm upgrade my-release bitnami-azure/fluentd \
