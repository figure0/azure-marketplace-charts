...
| `image.tag`                           | Apache MXNet (Incubating) image tag (immutable tags are recommended)                                                      | `1.9.1-debian-11-r59` |
...
| `git.tag`                              | Git image tag (immutable tags are recommended)                                                                                    | `2.38.1-debian-11-r10`  |
