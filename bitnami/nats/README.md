...
| `image.tag`              | NATS image tag (immutable tags are recommended)                                                       | `2.8.4-debian-11-r34` |
...
| `metrics.image.tag`                        | Prometheus metrics exporter image tag (immutable tags are recommended)                                 | `0.10.0-debian-11-r3`   |
