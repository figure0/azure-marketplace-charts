...
| `image.tag`            | NATS image tag (immutable tags are recommended)                                | `2.3.4-debian-10-r20` |
...
| `metrics.image.tag`                | Prometheus metrics exporter image tag (immutable tags are recommended)                                 | `0.8.0-debian-10-r56`   |
