...
| `image.tag`              | NATS image tag (immutable tags are recommended)                                                       | `2.6.4-debian-10-r14` |
...
| `metrics.image.tag`                        | Prometheus metrics exporter image tag (immutable tags are recommended)           | `0.9.0-debian-10-r16`   |
