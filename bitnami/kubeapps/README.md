...
| `frontend.image.tag`                             | NGINX image tag (immutable tags are recommended)                                          | `1.21.3-debian-10-r47` |
...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                       | `2.4.1-debian-10-r16`        |
...
| `authProxy.image.tag`                             | OAuth2 Proxy image tag (immutable tags are recommended)                       | `7.2.0-debian-10-r3`   |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                | `2.4.1-debian-10-r19`             |
...
| `testImage.tag`           | NGINX image tag (immutable tags are recommended)                              | `1.21.3-debian-10-r47` |
...
| `kubeappsapis.image.tag`                             | Kubeapps-APIs image tag (immutable tags are recommended)                                                                | `2.4.1-debian-10-r18`   |
