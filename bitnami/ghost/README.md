...
| `image.tag`         | Ghost image tag (immutable tags are recommended) | `4.16.0-debian-10-r0` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r202`     |
