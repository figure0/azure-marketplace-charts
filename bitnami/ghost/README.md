...
| `image.tag`         | Ghost image tag (immutable tags are recommended) | `4.12.1-debian-10-r0` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                        | `10-debian-10-r164`     |
