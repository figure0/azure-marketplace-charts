...
| `image.tag`         | Ghost image tag (immutable tags are recommended)                                                      | `5.20.0-debian-11-r0` |
...
| `volumePermissions.image.tag`                 | Bitnami Shell image tag (immutable tags are recommended)                                                      | `11-debian-11-r44`      |
