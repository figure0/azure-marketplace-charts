...
```console
$ helm repo add bitnami-azure https://marketplace.azurecr.io
$ helm install bitnami-azure/influxdb
```
...
```console
$ helm repo add bitnami-azure https://marketplace.azurecr.io
$ helm install --name my-release bitnami-azure/influxdb
```
...
```console
$ helm install --name my-release bitnami-azure/minio --set architecture="standalone"
```

or

```console
$ helm install --name my-release bitnami-azure/minio --set architecture="high-availability"
```
...
```console
$ helm install --name my-release -f values.yaml bitnami-azure/influxdb
```
