...
```console
$ helm repo add bitnami-azure https://marketplace.azurecr.io/helm/v1/repo
$ helm install my-release bitnami-azure/wavefront-hpa-adapter
```
...
| `image.tag`                             | Adapter image tag (immutabe tags are recommended)                                         | `0.9.8-scratch-r2`                   |
...
$ helm install my-release \
  --set livenessProbe.successThreshold=5 \
    bitnami-azure/wavefront-hpa-adapter
```
...
```bash
$ helm install my-release -f values.yaml bitnami-azure/wavefront-hpa-adapter
```
...
```bash
$ helm upgrade my-release bitnami-azure/wavefront-hpa-adapter
```