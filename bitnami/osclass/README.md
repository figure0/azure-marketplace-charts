...
| `image.tag`         | Osclass image tag (immutable tags are recommended) | `4.4.0-debian-10-r38` |
...
| `certificates.image.tag`                             | Apache Exporter image tag (immutable tags are recommended)                                | `10-debian-10-r112`                      |
