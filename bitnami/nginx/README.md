...
This major release no longer uses the bitnami-azure/nginx-ldap-auth-daemon container as a dependency since its upstream project is not actively maintained.
