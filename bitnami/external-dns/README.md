...
| `regexDomainFilter`                    | Limit possible target zones by regex domain suffixes. If regexDomainFilter is specified, domainFilters will be ignored (optional).                                                                              | `""`                                                    |
| `regexDomainExclusion`                 | Exclude subdomains by regex. If regexDomainFilter is specified, excludeDomains will be ignored and external-dns will use regexDomainExclusion (optional).                                                       | `""`                                                    |
